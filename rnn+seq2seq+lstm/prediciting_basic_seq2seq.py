...
def get_encoder_layer(input_data, rnn_size, num_layers,
    ...
    (encoder_output, encoder_state) = tf.nn.bidirectional_dynamic_rnn(cell_fw, cell_bw, encoder_embed_input,
...
def decoding_layer(target_letter_to_int, decoding_embedding_size, num_layers, rnn_size,
                   target_sequence_length, max_target_sequence_length, encoder_state, decoder_input, encoder_output):
    '''
    构造Decoder层
    ...
    encoder_output_fw, encoder_output_bw = encoder_output
